...
Grok Bot 0.30 already has a Computer. OpenBot lets that Computer talk to OpenCode's free models, OpenAI, OpenRouter, or any OpenAI-compatible API through Custom — without leaving the Grok Bot app. Official Grok is one click away when you want it back.
